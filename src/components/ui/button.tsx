  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-white shadow-medium hover:shadow-strong hover:scale-105 border-0",
        writer: "bg-writer text-writer-foreground hover:bg-writer/90 shadow-soft",
        client: "bg-client text-client-foreground hover:bg-client/90 shadow-soft",
        admin: "bg-admin text-admin-foreground hover:bg-admin/90 shadow-soft",
        crypto: "bg-crypto text-crypto-foreground hover:bg-crypto/90 shadow-soft",
      },
      size: {
